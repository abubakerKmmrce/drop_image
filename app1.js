...
async function saveImageToServer(file) {
	return new Promise(async (resolve, reject) => {
		...
		const response = await (new APIHelper()).post('image/create/', formData, { 'X-CSRFToken': csrf_token });
...
export function deleteFile(fileID, filesData) {
	return new Promise(async (resolve, reject) => {
		...
		try{
			// eslint-disable-next-line no-undef
			const response = await (new APIHelper()).delete('media/'+ serverID +'/delete/', {}, { 'X-CSRFToken': csrf_token });
...
export function updateFile(fileID, filesData) {
	...
	return new Promise(async (resolve, reject) => {
		...
		try{
			// eslint-disable-next-line no-undef
			const response = await (new APIHelper()).put('/media/'+ file.serverID + '/edit/', formData, { 'X-CSRFToken': csrf_token });
